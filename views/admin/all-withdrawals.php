...
/* @var $allWithdrawals app\models\Withdrawal[] */
/* @var $stats array */
/* @var $statusFilter string */
/* @var $searchTerm string */

$this->title = 'All Withdrawal Requests';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="admin-all-withdrawals">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="btn-group" role="group">
                                <?= Html::a('Pending Requests', ['pending-withdrawals'], [
                        ...
                        <div class="col-md-6 text-right">
                            <h6>Total Requests: <span class="badge badge-primary"><?= count($allWithdrawals) ?></span></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <?= Html::a('Reset', ['all-withdrawals'], ['class' => 'btn btn-secondary ml-2']) ?>
                    </div>
...
function processWithdrawal(id) {
    ...
    // Update form action URL with the correct id
    $('#processForm').attr('action', '<?= Url::to(['process-withdrawal']) ?>?id=' + id);
...
function completeWithdrawal(id) {
    ...
    // Update form action URL with the correct id
    $('#completeForm').attr('action', '<?= Url::to(['complete-withdrawal']) ?>?id=' + id);
