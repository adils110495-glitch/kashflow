	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img src="<?= Yii::getAlias('@web/images/logo.png') ?>" alt="" class="logo">
						<img src="<?= Yii::getAlias('@web/images/logo-icon.png') ?>" alt="" class="logo-thumb">
					</a>
				...
				<div class="collapse navbar-collapse">
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu profile-notification ">
									<ul class="pro-body">
												...
												<li><?= Html::beginForm(['/site/logout'], 'post', ['class' => 'form-inline']) . Html::submitButton('<i class="fas fa-sign-out-alt"></i> Logout', ['class' => 'btn btn-link logout dropdown-item']) . Html::endForm() ?></li>
											</ul>
								</div>
							</div>
						</li>
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
					<?= Html::beginForm(['/site/logout'], 'post', ['class' => 'form-inline']) . Html::submitButton('<i class="feather icon-log-out"></i><span class="d-none d-md-inline">Logout</span>', ['class' => 'btn btn-link logout nav-link', 'title' => 'Logout']) . Html::endForm() ?>
					</li>
						<li>
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="<?= Yii::getAlias('@web/images/user/avatar-1.jpg') ?>" alt="Generic placeholder image">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="<?= Yii::getAlias('@web/images/user/avatar-2.jpg') ?>" alt="Generic placeholder image">
												<div class="media-body">
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="<?= Yii::getAlias('@web/images/user/avatar-1.jpg') ?>" class="img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
