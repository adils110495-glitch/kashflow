                ...
                <div class="card-body">
                    ...
                    <div class="package-stats mb-4">
                        ...
                        <?php if (!empty($packageStats)): ?>
                            <div class="row">
                                <?php foreach ($packageStats as $packageName => $stats): ?>
                                    <div class="col-md-4 col-lg-3 mb-3">
                                        <div class="info-box bg-primary">
                                            <span class="info-box-icon"><i class="fas fa-box"></i></span>
                                            <div class="info-box-content">
                                                <span class="info-box-text"><?= Html::encode($stats['name']) ?></span>
                                                <span class="info-box-number"><?= $stats['count'] ?> (<?= $stats['percentage'] ?>%)</span>
                                                <div class="progress">
                                                    <div class="progress-bar bg-light" style="width: <?= $stats['percentage'] ?>%"></div>
                                                </div>
                                                <span class="progress-description">
                                                    <small>
                                                        <i class="fas fa-check text-success"></i> Paid: <?= $stats['paid_count'] ?> | 
                                                        <i class="fas fa-clock text-warning"></i> Unpaid: <?= $stats['unpaid_count'] ?>
                                                    </small>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="info-box bg-success">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?= array_sum(array_column($packageStats, 'paid_count')) ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="info-box bg-warning">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?= array_sum(array_column($packageStats, 'unpaid_count')) ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="info-box bg-info">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?= array_sum(array_column($packageStats, 'count')) ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="info-box bg-secondary">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">
                                                <?php 
                                                $totalPaid = array_sum(array_column($packageStats, 'paid_count'));
                                                $totalMembers = array_sum(array_column($packageStats, 'count'));
                                                $paymentRate = $totalMembers > 0 ? round(($totalPaid / $totalMembers) * 100, 1) : 0;
                                                echo $paymentRate . '%';
                                                ?>
                                            </span>
                                        </div>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle"></i> No package statistics available.
                            </div>
                        <?php endif; ?>
                    </div>
